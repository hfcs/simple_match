                      ...
                      child: Column(
                        children: [
                          DropdownButtonFormField<int>(
                            ...
                            initialValue:
                                stages.any((s) => s.stage == vm.selectedStage)
                                ? vm.selectedStage
                                : null,
                            items: stages
                                .map(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  _timeController.text = newVal.toStringAsFixed(
                                    2,
                                  );
                          ...
                          Row(
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  final n =
                                      int.tryParse(_dController.text) ?? 0;
                                  final newVal = (n - 1).clamp(0, 999);
                                  _setD(vm, newVal);
                                },
                              ),
                          ...
                          Row(
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  final n =
                                      int.tryParse(_missesController.text) ?? 0;
                                  final newVal = (n - 1).clamp(0, 999);
                          ...
                          Row(
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  final n =
                                      int.tryParse(_noShootsController.text) ??
                                      0;
                                  final newVal = (n - 1).clamp(0, 999);
                          ...
                          ElevatedButton(
                            ...
                            onPressed: isValid
                                ...
                                : null,
                            child: Text(
                              _editingKey == null ? 'Submit' : 'Update',
                            ),
                          ),
                          ...
                          Row(
                            children: [
                              Text(
                                'Hit Factor: ${vm.hitFactor.toStringAsFixed(2)}',
                              ),
                              const SizedBox(width: 16),
                              Text(
                                'Adjusted: ${vm.adjustedHitFactor.toStringAsFixed(2)}',
                              ),
                            ],
                          ),
                        ],
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            Text(
                              'Stage: ${r.stage}, Time: ${r.time.toStringAsFixed(2)}',
                            ),
                            Text(
                              'A: ${r.a}, C: ${r.c}, D: ${r.d}, Misses: ${r.misses}, No Shoots: ${r.noShoots}, Proc Err: ${r.procedureErrors}',
                            ),
                            Builder(
                              builder: (context) {
                                ...
                                return Text(
                                  'Hit Factor: ${r.hitFactor.toStringAsFixed(2)}, Adjusted: ${r.adjustedHitFactor(scale).toStringAsFixed(2)}',
                                );
                              },
                            ),
                          ],
