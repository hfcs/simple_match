...
void main() {
  testWidgets('Provider tree is set up and provides all viewmodels', (tester) async {
    ...
    expect(Provider.of<MainMenuViewModel>(context, listen: false), isA<MainMenuViewModel>());
    expect(Provider.of<MatchSetupViewModel>(context, listen: false), isA<MatchSetupViewModel>());
    expect(Provider.of<ShooterSetupViewModel>(context, listen: false), isA<ShooterSetupViewModel>());
    expect(Provider.of<StageInputViewModel>(context, listen: false), isA<StageInputViewModel>());
    expect(Provider.of<OverallResultViewModel>(context, listen: false), isA<OverallResultViewModel>());
  });
}
