            ...
            children: [
              pw.TableRow(
                children: [
                  ...
                  pw.Padding(
                    padding: const pw.EdgeInsets.all(4),
                    child: pw.Text('Match Points (after scaling)', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, font: font)),
                  ),
                ],
              ),
              ...
              children: [
                pw.TableRow(
                  children: [
                    ...
                    pw.Padding(padding: const pw.EdgeInsets.all(4), child: pw.Text('Match Pt (After Scaling)', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, font: font))),
                ...
                ...() {
                  ...
                  resultRows.sort((a, b) => (b['adjustedMatchPoint'] as double).compareTo(a['adjustedMatchPoint'] as double));
                  
                  return resultRows.map((row) {
                    final r = row['result'];
                    final rawHF = row['rawHF'] as double;
                    final scaledHF = row['scaledHF'] as double;
                    final adjustedMatchPoint = row['adjustedMatchPoint'] as double;
                    return pw.TableRow(
                      children: [
                        ...
                        pw.Padding(padding: const pw.EdgeInsets.all(4), child: pw.Text(adjustedMatchPoint.toStringAsFixed(2), style: pw.TextStyle(font: font))),
