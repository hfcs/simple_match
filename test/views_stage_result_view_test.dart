...
class MockPersistenceService extends PersistenceService {
  ...
  MockPersistenceService({required this.mockResults, required this.mockShooters, required this.mockStages});
  @override
...
void main() {
  testWidgets('StageResultView displays detailed sortable table with fixed column widths', (WidgetTester tester) async {
    ...
    final results = [
      StageResult(stage: 1, shooter: 'Alice', time: 12.0, a: 8, c: 2, d: 0, misses: 0, noShoots: 0, procedureErrors: 1),
      StageResult(stage: 1, shooter: 'Bob', time: 10.0, a: 7, c: 3, d: 0, misses: 0, noShoots: 1, procedureErrors: 0),
    ];
